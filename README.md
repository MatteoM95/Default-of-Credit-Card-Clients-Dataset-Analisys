...
$$ X\in \mathbb{R}^{n\times d} , dataset\ centered\ in\ zero__
\Sigma :=\frac{X^{T} X}{n-1},\ sample\ covariance\ matrix__
find\ \ \overrightarrow{z_{1}} :=a_{1} \overrightarrow{e_{1}} +...+a_{d}\overrightarrow{e_{d}}__
